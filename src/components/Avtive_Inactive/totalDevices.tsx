...
const TotalDevices = () => {
  ...
  return (
    <div className="mt-5 mb-4">
      <div className="card w-auto bg-gradient-to-r from-[#0165B9] to-[#23A5CE] text-white shadow-lg">
        <div className="items-center text-center">
          <div className="flex flex-col justify-center items-center py-10">
            <div className="card-title text-6xl font-bold mb-2">{totalDevices}</div>
